...
function MyApp(props) {
  ...
  (external_axios_default()).defaults.headers.common.Authorization = 'Bearer ' + getCookieByName('uclaim'); // React.useEffect(() => {
  //   // set axios defaults
...
MyApp.getInitialProps = async ({
  ...
  console.log(ctx);
  console.log(ctx.req.headers.cookie); // const { user } = ctx.store.getState();
  // if (ctx.req) {
  //   try {
...
var __webpack_exports__ = __webpack_require__.X(0, [3,928,168], () => (__webpack_exec__(7106)));
